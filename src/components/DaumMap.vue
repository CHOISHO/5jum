<template>
<div class="map_wrap">
    <div class="map" style="width:100vw;height:100vh;"></div>
    <div id="menu_wrap" class="bg_white">
        <div class="option">
            <div>
                <form v-on:submit.prevent="searchMap">
  ...
  methods: {
    ...
    creatMap(){
      ...
      var options = { //지도를 생성할 때 필요한 기본 옵션
          center: new daum.maps.LatLng(37.5168376, 127.0381266,643),
          level: 3
      };
    ...
    searchMap(){
      ...
      function searchPlaces() {
          ...
          ps.keywordSearch( keyword, placesSearchCB,{
            location: new daum.maps.LatLng(37.5168376, 127.0381266,643),
            radius: 1000    
          }); 
      }
